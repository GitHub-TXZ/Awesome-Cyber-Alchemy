...
#     files_gt = set(file for file in os.listdir(path_gt) if file.endswith('.nii.gz'))
#     files_pred = set(file for file in os.listdir(path_pred) if file.endswith('.nii.gz'))
#     common_files = files_gt.intersection(files_pred)
#     dice_list = []
#     hd95_list = []
#     nsd_list = []
#     assd_list = []
#     if not common_files:
#         print("No common .nii.gz files found.")
#         return
#     for file_name in common_files:
#         file_path_gt = os.path.join(path_gt, file_name)
#         file_path_pred = os.path.join(path_pred, file_name)
#         try:
...
#             hd95_list.append(binary.hd95((data_gt == 1), (data_pred == 1), voxelspacing=voxel_spacing[::-1]))
...
#     path_gt = '/home/kuanghl/Codes/txz/nnUNet_Database/nnUNet_preprocessed/Dataset997_ProveIT/gt_segmentations'
#     path_pred = '/home/kuanghl/Codes/txz/nnUNet_Database/nnUNet_results/Dataset997_ProveIT/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_0_nnUNet_proveit/validation'
