...
def run_training_entry():
    ...
    parser.add_argument('-dataset_name_or_id', type=str,default='13',
    ...
    parser.add_argument('--val', action='store_true', required=False, default = True,
    ...
    parser.add_argument('-model_name', type=str, default='UXNET_3D', help="specify the network to use. Default: nnUNet")
    parser.add_argument('-ex_name', type=str, default='Ex1@b_2_p_128_128_128_s_1.0_1.0_1.0', help="experiment name.")
