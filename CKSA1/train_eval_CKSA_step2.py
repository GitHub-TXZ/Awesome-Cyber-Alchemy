...
import numpy as np
import torch
from CKSA_GCN_step import CKSA
from opt1 import *
...
if __name__ == '__main__':
    ...
    a = 0
    if a == 0:
        for K1 in [1,2,3,4,5,6,7,8]:
            asdw = 0.55
            Over_all(named, K1)
    else:
        for K1 in [8]:#0.1,0.15,0.20,0.25,0.3,0.35,0.55,0.65,0.7,0.9    0.45,0.75,0.85,0.4,0.60.85,0.45
                asdw = 0.55
                      ...
                      for k in xy:
                          if da == 1 or da == 0:
                            ...
                            for fold in range(n_folds):
                                ...
                                fold_model_path = opt.ckpt_path + "/fold{}_region{}_method{}_{}_{}_CKSA_step2{}.pth".format(fold,region,k,da,asdw,K1)
                                ...
                                def evaluate():
                                    ...
                                    save(logits_test, y[test_ind], local=ids[test_ind], named=named, region=region,asdw=K1)
