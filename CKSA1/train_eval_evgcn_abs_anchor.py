...
if __name__ == '__main__':
    for asdw in [0.75]:
            book_name_xls = f'消融实验取消脑启发 gl={asdw}.xls'
            ...
            dropout = {"M1": 0.1, "M2": 0.1, "M3": 0.01, "M4": 0.01, "M5": 0.1, "M6": 0.1, "I": 0.1, "C": 0.1, "L": 0.1,
                       "IC": 0.1,"ALL":0.1}
            num_iter = {"M1": 500, "M2": 500, "M3": 500, "M4": 500, "M5": 500, "M6": 500, "I": 500, "C": 500, "L": 500,
                        "IC": 500,"ALL":500}
                            ...
                            def train():
                                ...
                                for epoch in range(num_iter[region]):
                                    ...
                                    with torch.set_grad_enabled(True):
                                        ...
                                        topk_index = dl.find_k_largest_indices(20, train_ind, test_ind, val, [-1])
