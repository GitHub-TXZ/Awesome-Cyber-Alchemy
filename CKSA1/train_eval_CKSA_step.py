...
if __name__ == '__main__':
    ...
    a = 0
    if a == 0:
        for proportion1 in [0.25, 0.05]:
            Over_all(named, proportion1)
    else:
        for proportion1 in [0.25, 0.05]:#0.1,0.15,0.20,0.25,0.3,0.35,0.55,0.65,0.7,0.9    0.45,0.75,0.85,0.4,0.60.85,0.45
                asdw = 0.55
                book_name_xls = f'step={proportion1}.xls'
                      ...
                      for k in xy:
                          if da == 1 or da == 0:
                            ...
                            for fold in range(n_folds):
                                print("\r\n========================== Fold {},{},{} ==========================".format(fold, region, proportion1))
                                ...
                                fold_model_path = opt.ckpt_path + "/fold{}_region{}_method{}_{}_{}_CKSA_YUAN1_{}.pth".format(fold,region,k,da,asdw,proportion1)
                                ...
                                def evaluate():
                                    ...
                                    save(logits_test, y[test_ind], local=ids[test_ind], named=named, region=region,asdw=proportion1)
