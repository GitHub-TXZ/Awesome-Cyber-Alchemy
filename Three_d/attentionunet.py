...
class AttentionUNet(nn.Module):
    def __init__(self, in_ch=1, base_ch=32, scale=[[1, 2, 2], [1, 2, 2], 2, 2], kernel_size=[3, 3, 3, 3, 3], num_classes=3, block='SingleConv', pool=True, norm='bn'):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = AttentionUNet(in_ch=1, base_ch=32, scale=[[1, 2, 2], [1, 2, 2], 2, 2], kernel_size=[3, 3, 3, 3, 3],
